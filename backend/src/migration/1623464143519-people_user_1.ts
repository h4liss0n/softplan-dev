...
export class peopleUser11623464143519 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        INSERT INTO public.people(
            ...
            VALUES (1, 'halisson@hotmail.com', 'Halisson' , 'Skalee', 'halisson@gmail.com', '123', 'M' , 'Brasileiro', 'Brasileiro', '1989-06-21', '081-610-819-64',  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
